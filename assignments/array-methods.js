...
// Problem 1
let smallDonation = runners.filter( donation => {
  return donation.donation <= 100
})
console.log(smallDonation)

// Problem 2
let emails = runners.map( email => {
  return email.email
})
console.log(emails)

// Problem 3
let example = runners.filter(stuff => {
  return stuff.email.startsWith("a")
})
console.log(example)